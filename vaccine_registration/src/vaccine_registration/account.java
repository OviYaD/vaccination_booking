...
JFrame f;
	...
	public account( final String[][] inputs,final int i,final boolean flag) {
		...
		TitledBorder border=new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED), "Not Vaccinated", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 128));
		...
		schedule1.addActionListener(new ActionListener() {
		...
		TitledBorder border1=new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED), "Not Vaccinated", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 128));
		...
		schedule2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		home.setIcon(new ImageIcon("C:\\Users\\hp\\Desktop\\APJ\\home.png"));
		...
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\hp\\Desktop\\APJ\\success.jpg"));
