...
public class successfull {
	...
	public successfull(final String[][] inputs,final int i,final boolean flag)  {
		...
		img_download.setIcon(new ImageIcon("C:\\Users\\hp\\Downloads\\download (1).png"));
		img_download.setBounds(662, 24, 38, 32);
		panel1.add(img_download);
		
		JLabel download_lb = new JLabel("Download");
		download_lb.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
		            ...
		            String path = "C:\\Users\\hp\\Desktop\\APJ\\registrations\\confirmationcard"+image+".jpg";
		...
		JLabel info_lb = new JLabel("Your appointment details have been sent on your registered mobile number through an SMS.");
		...
		JLabel instruct_1 = new JLabel("1.Please carry the Photo Id card mentioned in your appointment details for vaccination.");
		instruct_1.setFont(new Font("Tw Cen MT", Font.PLAIN, 15));
		instruct_1.setBounds(46, 409, 771, 24);
		panel1.add(instruct_1);
		
		JLabel instruct_2 = new JLabel("2.If you have any comorbidities, please carry a medical certificate with you for the vaccination center.");
		instruct_2.setFont(new Font("Tw Cen MT", Font.PLAIN, 15));
		instruct_2.setBounds(46, 438, 771, 24);
		panel1.add(instruct_2);
		
		JLabel instruct_3 = new JLabel("3.For more information, please call covid Toll Free number 1075");
