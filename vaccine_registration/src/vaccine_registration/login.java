...
public class login {
	...
	public static void main(String[] args) {
		...
		JLabel label2 = new JLabel("An OTP will be sent to your mobile number for verification");
		...
		ph_no.addMouseListener(new MouseAdapter() {
			@Override
		...
		ph_no.addKeyListener(new KeyAdapter() {
			@Override
		...
		ph_no.addActionListener(new ActionListener() {
		...
		getotp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					// Construct data
					String apiKey = "apikey=" + "Nzg3NTcxNDY0ZjRmNzkzNzMyNTM0YjZlMzg2NDc3NmU=";
		...
		aarogyaSetu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		aarogyaSetu.setIcon(new ImageIcon("C:\\Users\\hp\\Desktop\\APJ\\aarogya_setu.jpg"));
		aarogyaSetu.setBounds(27, 437, 160, 95);
		panel.add(aarogyaSetu);
		
		JLabel label4 = new JLabel("-------------- OR BOOK APPOINTMENT USING ---------------");
		label4.setFont(new Font("Garamond", Font.BOLD, 15));
		label4.setBounds(0, 371, 409, 41);
		panel.add(label4);
		
		JButton umang = new JButton("New button");
		umang.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String url = "https://web.umang.gov.in/web_new/login?redirect_to=department%3Furl%3Dcowin%2F%26dept_id%3D355%26dept_name%3DCo-WIN"; 
				try {
					java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
				} catch (IOException e1) {
					// TODO Auto-generated catch block
		...
		umang.setIcon(new ImageIcon("C:\\Users\\hp\\Desktop\\APJ\\UMANG-Logo.png"));
		...
		img_lab.setIcon(new ImageIcon("C:\\Users\\hp\\Desktop\\APJ\\eclipse-workspace\\vaccine_booking\\src\\login.png"));
