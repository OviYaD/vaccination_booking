...
public class welcome {
	...
	public welcome(final String[][] inputs) {
		...
		img.setIcon(new ImageIcon("C:\\Users\\hp\\Desktop\\APJ\\welcome.png"));
		img.setBounds(63, -17, 409, 350);
		panel.add(img);
		
		JLabel label1 = new JLabel("You can register 4 members with one mobile number");
		...
		JLabel label3_1 = new JLabel("Note: One registration per person is sufficient. Please do not ");
		label3_1.setFont(new Font("Segoe UI", Font.PLAIN, 17));
		label3_1.setBounds(29, 486, 459, 33);
		panel.add(label3_1);
		
		JLabel label3_2 = new JLabel("register with multiple mobile numbers or different Photo ");
		...
		JLabel label3_4 = new JLabel("Scheduling of Second dose should be done from the same ");
		label3_4.setFont(new Font("Segoe UI", Font.PLAIN, 17));
		label3_4.setBounds(29, 561, 459, 33);
		panel.add(label3_4);
		
		JLabel label3_5 = new JLabel("account (same mobile number) from which the first dose ");
		label3_5.setFont(new Font("Segoe UI", Font.PLAIN, 17));
		label3_5.setBounds(29, 586, 459, 33);
		panel.add(label3_5);
		
		JLabel label3_6 = new JLabel("has been taken, for generation of final certificate. Separate ");
		label3_6.setFont(new Font("Segoe UI", Font.PLAIN, 17));
		label3_6.setBounds(29, 611, 459, 33);
		panel.add(label3_6);
		
		JLabel label3_7 = new JLabel("registration for second dose is not necessary.");
